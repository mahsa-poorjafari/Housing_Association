...
class ComplaintsControllerTest < ActionController::TestCase
  ...
  test "should create complaint" do
    assert_difference('Complaint.count') do
      post :create, complaint: { complaint_answer: @complaint.complaint_answer, complaint_text: @complaint.complaint_text, user_id: @complaint.user_id }
    end
  ...
  test "should update complaint" do
    patch :update, id: @complaint, complaint: { complaint_answer: @complaint.complaint_answer, complaint_text: @complaint.complaint_text, user_id: @complaint.user_id }
    assert_redirected_to complaint_path(assigns(:complaint))
  end
