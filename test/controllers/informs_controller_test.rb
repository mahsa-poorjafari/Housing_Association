...
class InformsControllerTest < ActionController::TestCase
  ...
  test "should create inform" do
    assert_difference('Inform.count') do
      post :create, inform: { important: @inform.important, number_visit: @inform.number_visit, text: @inform.text, title: @inform.title }
    end
  ...
  test "should update inform" do
    patch :update, id: @inform, inform: { important: @inform.important, number_visit: @inform.number_visit, text: @inform.text, title: @inform.title }
    assert_redirected_to inform_path(assigns(:inform))
  end
